...
export const GithubLink = ({link, size = 32, className = ""}: IconLinkProps) => {
    return (
        <a className = {`block hover:text-accent ${className}`} href = {link} target="_blank" rel="noopener noreferrer" title="GitHub">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" fill="currentColor" width = {size} height = {size}>
